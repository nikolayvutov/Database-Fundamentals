    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (SqlConnection connection = new SqlConnection(Configuration.ConnectionString))
            {
                ...
                string insertEvillnesFactors = "INSERT INTO EvilnessFactors (Name) VALUES ('Super good'),('Good'),('Bad'), ('Evil'),('Super evil')";
                ...
                ExecuteNonQuery(tableEvilnessFactors, connection);
                ExecuteNonQuery(tableVillians, connection);
                ...
                ExecuteNonQuery(insertEvillnesFactors, connection);
        ...
        private static void ExecuteNonQuery(string databaseSql, SqlConnection connection)
        {
